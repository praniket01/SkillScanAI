...
const upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file } : {companyName : string, jobTitle : string, jobDescription : string , file : File}) => {
        ...
        if(!uploadedFile) return setStatusText('Error in uploading file');

        setStatusText('Converting to impage...');
    ...
    <main className="bg-[url('/images/bg-main.svg')] bg-cover">
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    <h1>Lets see what your resume has to say</h1>
                    {isProcessing ? (
                        <>
                            <h2>{statusText}</h2>
                        ...
                        <h2>Want to check ATS Score of your Resume and get insight points</h2>
                    )}
                    {!isProcessing && (
